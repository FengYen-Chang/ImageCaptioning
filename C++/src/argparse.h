...
static const char model_message_decoder[] = "Required. Path to an .xml file with a trained decoder model.";

/// @brief message for model argument
static const char model_message_encoder[] = "Required. Path to an .xml file with a trained encoder model.";
...
static const char text_length_message[] = "Set the max length of output text";
...
/// It is a required parameter
DEFINE_string(m_d, "", model_message_decoder);

/// @brief Define parameter for set model file <br>
/// It is a required parameter
DEFINE_string(m_e, "", model_message_encoder);
...
DEFINE_int32(tl, 20, text_length_message);
...
static void showUsage() {
    ...
    std::cout << "    -m_d \"<path>\"             " << model_message_decoder << std::endl;
    std::cout << "    _m_e \"<path>\"             " << model_message_encoder << std::endl;
    ...
    std::cout << "    -tl \"<integer>\"         " << text_length_message << std::endl;
}
